    ...
    <el-row :gutter="0" class="block__body-row">
      <el-col :span="8">
        <span class="block__body-item">
          ...
          <el-input v-if="ifEdit" style="max-width: 200px;" v-model="detailInfo.id" disabled />
      ...
      <el-col :span="8">
        <span class="block__body-item">
          ...
          <div class="input-box" v-if="ifEdit" :class="{'is-error': !editInfo.name}">
            <el-input v-model="editInfo.name" style="max-width: 200px;" clearable maxlength="32" />
